...
acil = PRANKBOTS.LINE() 
acil.login(token="EsIenu35bLwdFlul12F4.auNM10yG7IyUwLD58b7JLa.BETZKflECBsA/qeI1mKnDiMLLAI1g2rPqFdopgs4dUM=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="Es4Q8hRpZencX6Jom7Uc.zaYiYYR9HlvC8KN/wCLlxa.bqNKy23UuOtHJw9Ymgb9/CXpjokZsiQQtHEr3SQCU1A=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="Es1dyze6K43hYXv7wV0c.zaYiYYR9HlvC8KN/wCLlxa.5YauUXaGZt4xQHMWITf8Ti8YdiiSbUMJYE9QWs0Vtnw=")
pb2.loginResult()
...
admsa = "u0149e6d74620ee262e5a5779f01ee394"
                ...
                if wait["wblack"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        try:
                            ...
                            cu = ""
                        acil.sendText(msg.to,"[displayName]:\n" + msg.contentMetadata["displayName"] + "\n[mid]:\n" + msg.contentMetadata["mid"] + "\n[statusMessage]:\n" + contact.statusMessage + "\n[pictureStatus]:\http://line.me/ti/p/%40mtz3566v/" + contact.pictureStatus + "\n[coverURL]:\n" + str(cu))
                    else:
                        contact = acil.getContact(msg.contentMetadata["mid"])
                        try:
                            cu = acil.channel.getCover(msg.contentMetadata["mid"])
...
#                else:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    acil.sendText(msg.to,"􀜁􀇔􏿿semua nama di ganti jadi anu\n👉 " + string + "👈")
...
#--------------------------------------------------------
                ...
                acil.sendText(msg.to,"mid:uf063ac50cfddc4024e8ca76001cae939")
                msg.contentType = 13
                msg.contentMetadata = {}
                acil.sendMessage(msg)
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)
                if wait["lang"] == "JP":
                    acil.sendText(msg.to,"si anu udah kluar dri room")
                else:
...
#-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["Dor","Tagall","Crot","Sepi"]:
                group = acil.getGroup(msg.to)
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#-----------------------------------------------
            elif msg.text in ["Welcome","Kibar","welcome","Wc"]:
                ginfo = acil.getGroup(msg.to)
                acil.sendText(msg.to,"permisi ya semua si tukang tikung mau anu " + str(ginfo.name))
                acil.sendText(msg.to,"http://line.me/ti/p/%40mtz3566v","http://line.me/ti/p/%40jbm0622j","http://line.me/ti/p/%40ewo1752h","http://line.me/ti/p/%40qph5561f")
            elif "Bc " in msg.text:
